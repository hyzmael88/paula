      ...
      <div className="mt-16">
        ...
        <div>
          <div className="w-full flex text-center mb-4">
            <div
              className={`w-full {selector==='Publicaciones ' ? "bg-[#D9D9D9] text-black" : "bg-[#e2e1e1] text-[#9b9b9b] } px-4 py-2 cursor-pointer uppercase`}
            ...
            <div
              className={`w-full ${selector==='Paquetes' ? "bg-[#D9D9D9] text-black" : "bg-[#e2e1e1] text-[#9b9b9b]" }  px-4 py-2 cursor-pointer uppercase`}
