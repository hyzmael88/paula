...
const Privacidad = () => {
  return (
    <div className="p-4">
      ...
      <h2 className="text-2xl font-bold mb-2">Qué Hacemos con la Información que Recopilamos</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mb-2">Cómo Usamos las Cookies</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mb-2">Control de su Información Personal</h2>
      <div className="mb-4">
